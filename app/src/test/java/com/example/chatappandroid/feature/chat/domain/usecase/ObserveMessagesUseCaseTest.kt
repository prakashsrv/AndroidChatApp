...
class ObserveMessagesUseCaseTest {
    ...
    @Test
    fun `invoke emits messages from repository`() =
        runTest {
    ...
    @Test
    fun `invoke emits empty list when no messages`() =
        runTest {
    ...
    @Test
    fun `invoke emits multiple updates in order`() =
        runTest {
    ...
    @Test
    fun `messages are ordered by clientTimestamp ascending`() =
        runTest {
            val messages =
                listOf(
